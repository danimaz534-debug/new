      ...
      if (messages && messages.length > 0) {
        ...
        if (lastUserMessage) {
          ...
          if (userMessage.includes('price') || userMessage.includes('cost') || userMessage.includes('how much')) {
            aiResponse = 'I understand youre asking about pricing. Our team will provide you with detailed pricing information shortly.';
            ...
            aiResponse = 'Youre welcome! Is there anything else we can help you with?';
          }
        }
      }
